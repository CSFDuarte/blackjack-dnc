  ...
  return (
    <Container>
      <Grid container justifyContent="center" alignItems="flex-start" direction={'row'} my={1}>
        ...
        {/* BARALHO DE CARTAS */}
        <Grid container justifyContent="center" alignItems="flex-start" direction={'column'} my={2} sm={12} md={6}>
        ...
        <Grid container justifyContent="center" alignItems="center" direction={'column'} my={2} sm={12} md={6}>
          {/* CARTA COMPRADA */}
          {card && (<>
            <Typography variant="h4" align="center">
              Carta comprada
